...
def validate_user_in_group(current_user: models.User, user: models.User, group: models.Group):
...
def validate_user_in_activity(current_user: models.User, user: models.User, activity: models.Activity):
